  ...
  return (
    <span style={dialogStyle}>
      ...
      <Dialog
        ...
        <DialogContent>
          <AddMovieClass doMessage={props.doMessage} movie={props.movie} alert={props.alert} handleSubmitClose={handleClose} closeMovieInfo={props.closeMovieInfo} viewTrendingMovie={props.viewTrendingMovie} getMovieDetails={props.getMovieDetails} title={props.title} id={props.id} released={props.released} description={props.description} image={props.image} user={props.user} budget={props.budget}/>
        </DialogContent>
      </Dialog>
    </span>
  )
